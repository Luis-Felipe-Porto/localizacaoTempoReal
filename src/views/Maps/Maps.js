...
const createMarker = ()=>{
  ...
  // if(lat){
    return people.map((value,key)=><Marker key={key} position={{ lat: value.lat, lng: value.lon}} icon={markerIcon}/>)
 // }
...
export default function Maps() {
  ...
  return (
    <CustomSkinMap
      googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyCJq_W9lJN4NTNoQTXKoUuUxpW0QV8etKY"
